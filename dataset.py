...
class ASVspoof2021(Dataset):
    def __init__(self, access_type, path_to_features, path_to_protocol, part='train', feature='LFCC',
        ...
        self.path_to_audio = os.path.join(self.ptd, access_type, 'ASVspoof2021_'+access_type+'_'+ self.part +'/flac/')
        self.genuine_only = genuine_only
        self.feat_len = feat_len
        self.feature = feature
        self.path_to_protocol = path_to_protocol
        self.padding = padding
        protocol = os.path.join(self.path_to_protocol, 'ASVspoof2021.'+access_type+'.cm.'+ self.part + '.trl.txt')
...
if __name__ == "__main__":
    path_to_database = r'C:\Users\Serilda\Desktop\Final Year Project\ASVspoof2021_LA_eval\audioflac' 
